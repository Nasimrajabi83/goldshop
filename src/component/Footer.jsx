      ...
      <Container>
        <Row className="text-center text-md-start">
          ...
          <Col md={6} className="mb-3">
            <h5 className="brand tfooter  mb-3 fw-bold">GoldShop</h5>
          </Col>

          {/* ستون ۲ */}
          <Col md={3} className="mb-3">
            <h6 className="tfooter fw-bold mb-3">ارتباط با ما</h6>
          ...
          {/* ستون ۳ */}
          <Col md={3}>
            <h6 className="tfooter fw-bold mb-3">ما را دنبال کنید</h6>
            <div className="d-flex  justify-content-center justify-content-md-start gap-3">
              <a href="#" className="fs-4"><FaInstagram /></a>
              <a href="#" className="fs-4"><FaTelegram /></a>
            </div>
          </Col>
        </Row>
        <hr className="border-secondary my-3" />
        <p className="text-center tfooter small mb-0">
